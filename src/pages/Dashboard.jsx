                ...
                <div style={{width: 290, flexShrink: 0, display: "flex", flexDirection: "column", gap: 16}}>
                    ...
                    >
                        ...
                        >
                            {CALENDAR_DAYS.map((d) => (
                                <div
                                    key={d}
                                    style={{fontSize: 11, fontWeight: 600, color: "#94a3b8", paddingBottom: 6}}
                                >
                                    {d}
                                </div>
                            ))}
                    ...
                    >
                        ...
                        >
                            ...
                            <span style={{color: "#94a3b8", fontSize: 16, cursor: "pointer", letterSpacing: 2}}>
                                ···
                            </span>
                        </div>
                        <div style={{display: "flex", flexDirection: "column", gap: 10}}>
                            {AGENDA.map((item, i) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <div style={{fontSize: 11, color: "#6366f1", fontWeight: 700, marginBottom: 3}}>
                                            {item.grade}
                                        </div>
